...
const StartupForm = () => {
  ...
  const handleFormSubmit = async (prevState: any, formData: FormData) => {
    try{
        ...
        // setErrors({})
        //const res = await createIdea(formValues)
        // if(result.status == 'SUCCESS'){
        //     toast.success("Your startup pitch was submitted!")
  ...
  const [state, formAction, isPending] = useActionState(handleFormSubmit, {error: '',status:"INTIAL"});


  return (
    <form action={formAction} className='startup-form'>
      <div>
        <label htmlFor="title" className='startup-form_label mb-2 block'>Title</label>
      ...
      <div>
        <label htmlFor="description" className='startup-form_label mb-2 block'>Description</label>
      ...
      <div>
        <label htmlFor="category" className='startup-form_label mb-2 block'>Category</label>
      ...
      <div>
        <label htmlFor="link" className='startup-form_label mb-2 block'>Image Url</label>
      ...
      <div data-color-mode="light">
        <label htmlFor="pitch" className='startup-form_label mb-2 block'>Pitch</label>
        <MDEditor 
        value={pitch} 
